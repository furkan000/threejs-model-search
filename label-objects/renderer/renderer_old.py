...
def render_to_image(scene, filename="rendered_image.png", camera_pose=None):
    color, depth = pyrender.OffscreenRenderer(1600, 1600).render(scene)
...
def render_meshes_from_scene(glb_path, output_dir, yfov=np.pi / 7.0, aspect_ratio=1.0):
    """
...
# render_meshes_from_scene("./classroom.glb", "./render_classroom")
render_meshes_from_scene("./low_poly_bedroom.glb", "./render_bedroom")