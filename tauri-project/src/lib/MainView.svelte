<script>
  ...
  import { updateObjectNamesWithDescription, run, renameObjectById, findObjectById, model, updateTreeObject, highlightObjectById, importExternalFunction, downloadGLB, saveToDir, replaceModel } from "./scene";
...
<body>
  ...
  <div class="fixed bottom-4 right-4">
    <button on:click={updateObjectNamesWithDescription} class="btn"> test </button>
