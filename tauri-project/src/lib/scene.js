...
export function downloadGLB() {
  ...
  updateObjectNamesWithDescription();
...
export function updateObjectNamesWithDescription() {
  scene.traverse((object) => {
    // if the name already contains ###, split it and update the name and description
    if (object.name.includes("###")) {
      const [name, description] = object.name.split("###");
      object.name = name;
      if (description == null) {
        object.description = description;
      }
    }
    // if the object has a description, append it to the name
    if (object.description != null) {
      object.name = object.name + "###" + object.description;
